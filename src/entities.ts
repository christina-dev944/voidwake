...
const ENEMY_TYPES: Record<string, EnemyType> = {
  ...
  striker:{ r:15, hpMul:0.9,  spd:0.7,  pattern:'aimed', move:'drift', fireMul:1.5,  hue:()=>rand(248,262), minWave:5, weight:2, shape:'stick', bulletR:5, bulletSpdMul:1.6, burst:3, burstGap:12 },
